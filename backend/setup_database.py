...
This script creates the keyspace and all required tables for the library reservation system.
...
def create_keyspace_and_tables():
    ...
    # Connect to Cassandra cluster (without specifying keyspace initially)
    try:
    ...
    try:
        ...
        expected_tables = ['reservations', 'reservations_by_user', 'reservations_by_book', 'books', 'users']
...
def show_connection_info():
    ...
    print("  Trying to connect to: 127.0.0.1, 127.0.0.2, 127.0.0.3")
    print("  Default ports: 9042 (CQL), 7000 (inter-node)")
    print("  Keyspace: data")
    ...
    print("  2. Ports 9042 and 7000 are accessible")
